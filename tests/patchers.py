...
PATCH_SETUP_ENTRY = patch(
    "custom_components.androidtv_custom.async_setup_entry",
    return_value=True,
)
PATCH_ACCESS = patch("custom_components.androidtv_custom.os.access", return_value=True)
PATCH_ISFILE = patch("custom_components.androidtv_custom.os.path.isfile", isfile)
