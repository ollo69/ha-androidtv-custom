...
from custom_components.androidtv_custom.media_player import (
    ATTR_DEVICE_PATH,
    ATTR_LOCAL_PATH,
    PREFIX_ANDROIDTV,
    PREFIX_FIRETV,
...
def load_adbkey_fixture() -> None:
    """Patch load_adbkey."""
    with patch(
        "custom_components.androidtv_custom.ADBPythonSync.load_adbkey",
...
def keygen_fixture() -> None:
    """Patch keygen."""
    with patch(
        "custom_components.androidtv_custom.keygen",
        return_value=Mock(),
    ):
        yield
